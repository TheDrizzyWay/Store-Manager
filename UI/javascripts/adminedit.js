...
function showResult(e) {
	...
	if (selected == "products") {
		...
		resultDiv.className = "resultDiv";
		resultDiv.innerHTML =`<ol>
			<li>Sample category 1<a href="#" class="modify">Modify</a><a href="#" class="delete">Delete</a></li><br>
			<li>Sample category 2<a href="#" class="modify">Modify</a><a href="#" class="delete">Delete</a></li><br>
			<li>Sample category 3<a href="#" class="modify">Modify</a><a href="#" class="delete">Delete</a></li><br>
		</ol>`;
		return; 
	} else {
		resultDiv.className = "resultDiv";
